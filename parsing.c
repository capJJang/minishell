...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/12/13 19:51:12 by seyang            #+#    #+#             */
/*   Updated: 2022/12/13 19:51:17 by seyang           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void    command_to_node(t_node_inf *node_inf, char *read_line)
{
...
t_node_inf  *parsing(char *read_line)
{
    ...
    command_to_node(node_inf, read_line);
    free(read_line);
    return (node_inf);
}
